function [ output_args ] = sift_encode_all_keyframes( szPat, sift_algo, param, codebook_size, clustering_algo, dimred, enc_type, spm, start_seg, end_seg )
...
function log (msg)
	fh = fopen('sift_encode_all_keyframes.log', 'a+');
