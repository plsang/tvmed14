...
#$ -q all.q@bc209.hpc.vpl.nii.ac.jp,all.q@bc210.hpc.vpl.nii.ac.jp,all.q@bc211.hpc.vpl.nii.ac.jp,all.q@bc212.hpc.vpl.nii.ac.jp,all.q@bc213.hpc.vpl.nii.ac.jp,all.q@bc214.hpc.vpl.nii.ac.jp,all.q@@bc3hosts,all.q@@bc4hosts
# Log starting time
date 
...
echo [$HOSTNAME] [$JOB_ID] [matlab -nodisplay -r "edutraj_encode_sge_alpha( '$1', '$2', $3, $4)"]
# change to the code dir  --> NEW!!! *** CHANGED ***
cd /net/per610a/export/das11f/plsang/codes/kaori-secode-med14.2
# Log info of current dir 

LD_PRELOAD="/net/per900a/raid0/plsang/usr.local/lib/libstdc++.so.6" matlab -nodisplay -r "edutraj_encode_sge_alpha( '$1', '$2', $3, $4)"
# Log ending time
date
